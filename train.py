...
for line in lines[: min(num_samples, len(lines) - 1)]:
    ### input_text는 입력값, target_text는 출력값
...
# 3D numpy 배열을 사용
# 첫번째 차원 = 고려한 sample의 수
# 두번째 차원 = 최대 seq 길이 (sample내에서 가장 긴 text길이)
# 세번째 차원 = input_character/target_character에 있는 고유한 문자의 수
# 1. encoder_input_data = 입력 data
# 2. decoder_input_data = 입력 data에 대응하는 출력 data
# 3. decoder_target_data = 출력 data 다음에 올 예상되는 data 
